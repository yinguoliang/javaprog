...
public abstract class LogManager {
    ...
    void serialLogInternal(LogItem[] itemArray, LogContext context)
        ...
        try {
            serialLogWork(itemArray, context);
        } catch (EnvironmentFailureException e) {
    ...
    /**
     * The work, other than exception handling, of the write critical section.
     */
    private void serialLogWork(LogItem[] itemArray, LogContext context)
        throws IOException, DatabaseException {
     ...
     */
    public abstract Map<Long, DbFileSummary>
        cloneDbFileSummaries(DatabaseImpl db);
