...
public class ReplicatedEnvironment extends Environment {
     ...
     * replica as the new master. This results in the environment at the
     * current master being invalidated. Any subsequent attempt to use this
     * environment will result in a {@code MasterReplicaTransitionException}
     * and the application will need to handle the exception as usual by
     * closing and re-establishing the environment handle.
     *
     ...
     * with {@code MasterReplicaTransitionException} since the environment has
     * been invalidated.
     * </ol>
     *
