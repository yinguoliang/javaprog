// $ANTLR 3.2 Sep 23, 2009 14:05:07 Expr.g 2017-01-20 16:34:11
...
public class ExprParser extends Parser {
    ...
    // $ANTLR start "stat"
    // Expr.g:9:1: stat : ( expr | NEWLINE );
    public final void stat() throws RecognitionException {
        try {
            // Expr.g:9:6: ( expr | NEWLINE )
            int alt1=2;
    ...
    // $ANTLR start "expr"
    // Expr.g:13:1: expr : multExpr ( ( '+' | '-' ) multExpr )* ;
    public final void expr() throws RecognitionException {
        try {
            // Expr.g:13:6: ( multExpr ( ( '+' | '-' ) multExpr )* )
            // Expr.g:13:8: multExpr ( ( '+' | '-' ) multExpr )*
            {
    ...
    // $ANTLR start "atom"
    // Expr.g:19:1: atom : ( '(' expr ')' | INT | ID );
    public final void atom() throws RecognitionException {
        try {
            // Expr.g:19:6: ( '(' expr ')' | INT | ID )
            int alt4=3;
            switch ( input.LA(1) ) {
            case 12:
                {
