 ...
 * <i>h...h</i>&nbsp;&lt;=&nbsp {@link java.lang.Character#MAX_CODE_POINT
 ...
 * *
 * <tr>
 * <td valign="top" headers="construct unicode"><tt>\p{IsLatin}</tt></td>
 ...
 * </tr>
 * <tr>
 * <td valign="top" headers="construct unicode"><tt>\p{IsAlphabetic}</tt></td>
 ...
 * <tt>"&#92;&#92;(hello&#92;&#92;)"</tt> must be used. <a name="cc">
 ...
 * expression <tt>-</tt> becomes a range forming metacharacter. <a name="lt">
 ...
 * matches just before a line terminator or the end of the input sequence. <a
 * name="cg">
 * <h4>Groups and capturing</h4> <a name="gnumber">
 * <h5>Group number</h5>
 * <p>
 ...
 * outside of a character class. <a name="usc">
 * <p>
 * <b>Scripts</b> are specified either with the prefix {@code Is}, as in
 * {@code IsHiragana}, or by using the {@code script} keyword (or its short form
 * {@code sc})as in {@code script=Hiragana} or {@code sc=Hiragana}.
 * <p>
 * The script names supported by <code>Pattern</code> are the valid script names
 * accepted and defined by
 * {@link java.lang.Character.UnicodeScript#forName(String)
 * UnicodeScript.forName}. <a name="ubc">
 * <p>
 * <b>Blocks</b> are specified with the prefix {@code In}, as in
 * {@code InMongolian}, or by using the keyword {@code block} (or its short form
 * {@code blk}) as in {@code block=Mongolian} or {@code blk=Mongolian}.
 * <p>
 * The block names supported by <code>Pattern</code> are the valid block names
 * accepted and defined by
 * {@link java.lang.Character.UnicodeBlock#forName(String) UnicodeBlock.forName}.
 * <p>
 * <a name="ucc"> <b>Categories</b> may be specified with the optional prefix
 ...
 * <p>
 * <a name="ubpc"> <b>Binary properties</b> are specified with the prefix
 ...
 * conformance with the recommendation of <i>Annex C: Compatibility
 * Properties</i> of <a href="http://www.unicode.org/reports/tr18/"><i>Unicode
 * Regular Expression </i></a>, when {@link #UNICODE_CHARACTER_CLASS} flag is
 * specified.
 * <p>
 ...
 * <tr>
 * <td><tt>\p{Print}</tt></td>
 * <td>A printable character: <tt>[\p{Graph}\p{Blank}&&[^\p{Cntrl}]]</tt></td>
 * </tr>
 * <tr>
 * <td><tt>\p{Blank}</tt></td>
 * <td>A space or a tab:
 * <tt>[\p{IsWhite_Space}&&[^\p{gc=Zl}\p{gc=Zp}\x0a\x0b\x0c\x0d\x85]]</tt></td>
 * </tr>
 * <tr>
 * <td><tt>\p{Cntrl}</tt></td>
 ...
 * <td><tt>\w</tt></td>
 * <td>A word character:
 * <tt>[\p{Alpha}\p{gc=Mn}\p{gc=Me}\p{gc=Mc}\p{Digit}\p{gc=Pc}]</tt></td>
 * </tr>
 * <tr>
 * <td><tt>\W</tt></td>
 ...
 * <p>
 * <tt>\h&nbsp;&nbsp;&nbsp;&nbsp;</tt>A horizontal whitespace
 * <p>
 * <tt>\H&nbsp;&nbsp;&nbsp;&nbsp;</tt>A non horizontal whitespace
 * <p>
 * <tt>\v&nbsp;&nbsp;&nbsp;&nbsp;</tt>A vertical whitespace
 * <p>
 * <tt>\V&nbsp;&nbsp;&nbsp;&nbsp;</tt>A non vertical whitespace
 * <p>
 * <tt>\R&nbsp;&nbsp;&nbsp;&nbsp;</tt>Any Unicode linebreak sequence
...
public final class Pattern implements java.io.Serializable {
     ...
     *             corresponding to the defined match flags are set in
     *             <tt>flags</tt>
     * @throws PatternSyntaxException If the expression's syntax is invalid
     */
    ...
    private int escape(boolean inclass, boolean create) {
        ...
        switch (ch) {
            ...
            case 'D':
                if (create)
                    root = has(UNICODE_CHARACTER_CLASS) ? new Utype(UnicodeProp.DIGIT).complement() : new Ctype(
            ...
            case 'S':
                if (create)
                    root = has(UNICODE_CHARACTER_CLASS) ? new Utype(UnicodeProp.WHITE_SPACE).complement() : new Ctype(
                            ASCII.SPACE).complement();
                return -1;
            case 'T':
            case 'U':
            case 'V':
    ...
    /**
     * Parse a character class, and return the node that matches it. Consumes a
     * ] on the way out if consume is true. Usually consume is true except for
     * the case of [abc&&def] where def is a separate right hand node with
     * "understood" brackets.
     */
    ...
    private CharProperty bitsOrSingle(BitClass bits, int ch) {
        ...
        char cc = (char)ch;
        if (ch < 256
                && !(has(CASE_INSENSITIVE) && has(UNICODE_CASE) && (ch == 0xff || ch == 0xb5 || ch == 0x49
                        || ch == 0x69 || //I and i
     ...
     * multiline mode. When not in multiline mode, the $ can only match at the
     * very end of the input, unless the input ends in a line terminator in
     * which it matches right before the last line terminator. Note that \r\n is
     * considered an atomic line terminator. Like ^ the $ operator matches at a
     * position, it does not match the line terminators themselves.
     */
     ...
     * restores them when the match is done. The matchRef is used when a
     * reference to this group is accessed later in the expression. The locals
     * will have a negative value in them to indicate that we do not want to
     * unset the group if the reference doesn't match.
     */
     ...
     * groups that have to be backed off of. The GroupTail node is also used
     * when a previous group is referenced, and in that case no group
    ...
    private static class CharPropertyNames {
        ...
        static {
            ...
            defCategory(
                    "C",
                    ((1 << Character.CONTROL) | (1 << Character.FORMAT) | (1 << Character.PRIVATE_USE) | (1 << Character.SURROGATE))); // Other
            defCategory(
                    "P",
